# Framework: Four Steps to Dangerous Intelligence with AI

> **Source:** [Give Me 18 Minutes and I'll Make you Dangerously Smart (with AI)](https://www.youtube.com/watch?v=A8_nNYLTXEQ)  
> **Author:** theMITmonk (MIT grad, AI company advisor)  
> **Version:** 1.1  
...
Four categories to immediately delegate to AI (Zone 1 only):
...
**The Four Camps (climbing the hill):**
...
| 4 | Agents | Hire multiple roles in one prompt | "Do deep research on trends on topic XYZ. Analyze and cross-reference to find the 3 most important. Draft a one-page memo summarizing findings." |

**On agents:** According to Salesforce, AI agents helped drive $67 billion in global sales during Cyber Week alone. Agents are already here.
...
**Key phrase:** "Have the courage to play the fool today so you can be the genius tomorrow."

**The deeper truth:** "The trick to mastery is going back to simplicity itself. Every master is a student for life. You can't be a genuine student if you're hiding behind a mask of mastery."

**Final insight:** "The biggest benefit of intelligence is not the end of ignorance. It's the end of pretending... The real purpose of intelligence, of this thing called life, is to travel far and wide only to return to yourself and fully accept who you are. That is your truest intelligence."
...
1. **Intelligent Laziness:**
   - You can clearly distinguish Zone 1 (capped) vs Zone 2 (uncapped) tasks
   - You're satisficing on Zone 1 tasks
   - You're obsessing over Zone 2 tasks
   - AI handles your DRAG work (Drafting, Research, Analysis, Grunt)
   - You have more time for high-leverage activities

2. **Intelligent Hill:**
   - You're not rolling the dice with zero-shot prompts
   - You provide examples, context, grounding to AI
   - You ask AI to show its work and think step by step
   - You're architecting questions, not just asking
   - You're driving the car, not the drunk genius

3. **Intelligent Gym:**
   - You distinguish information tasks from transformation tasks
   - You use AI as spotter, not wheelchair
   - You're applying progressive overload to learning
   - You feel resistance and discomfort in growth areas
   - AI makes you stronger, not dependent

4. **Intelligent Fool:**
   - You're comfortable saying "I don't know"
   - You ask basic questions without embarrassment
   - You feel stupid regularly (that's learning happening)
   - You embrace beginner's mind in your field
   - You're a student for life, not hiding behind mastery
...
1. **Intelligent Laziness failures:**
   - Treating all tasks as equal priority (completion bias)
   - Perfecting Zone 1 tasks (choosing fonts for internal slides)
   - Outsourcing Zone 2 tasks to AI (customer interactions, product design)
   - Not using DRAG on repetitive work
   - Spending 72% of time on non-needle-moving activities

2. **Intelligent Hill failures:**
   - Treating AI like a calculator expecting consistent answers
   - Using zero-shot prompts and hoping for the best
   - Not providing examples or context
   - Accepting AI's first answer without verification
   - Letting AI drive instead of architecting questions
...
Use these to check your AI usage against this framework:

### Intelligent Laziness
- [ ] Can I categorize my current tasks into Zone 1 (capped) vs Zone 2 (uncapped)?
- [ ] What am I perfecting that I should just satisfice?
- [ ] What am I outsourcing that I should obsess over?
- [ ] Am I applying DRAG to Zone 1 tasks?
- [ ] How much of my time goes to needle-moving activities?

### Intelligent Hill
- [ ] What camp am I currently at? (Zero/One/Few-shot, Chain of Thought, Agents)
...
- [ ] Am I using AI as spotter or wheelchair for this?
- [ ] Where am I applying progressive overload to my learning?
- [ ] Do I feel resistance and discomfort in my growth areas?
- [ ] Is AI making me stronger or more dependent?

### Intelligent Fool
- [ ] When did I last admit "I don't know" in my field?
- [ ] What do I pretend to understand that I actually don't?
- [ ] Am I asking basic questions or hiding behind expertise?
- [ ] Do I feel stupid regularly? (If not, am I learning?)
- [ ] Am I a student for life or frozen in mastery?

---

## The Two Frameworks Combined

| DRAG (Delegate) | Intelligent Hill (Prompt Better) |
|-----------------|----------------------------------|
| **D**rafting | One-shot with style examples |
| **R**esearch | Deep research agents |
| **A**nalysis | Chain of thought reasoning |
| **G**runt work | Simple automation |

| Information Task (Remove Friction) | Transformation Task (Add Friction) |
|-----------------------------------|-----------------------------------|
| Use AI to do it fast | Use AI as spotter to quiz you |
| DRAG framework applies | Progressive overload applies |
| Efficiency goal | Growth goal |

---

## Quick Reference: AIM Protocol for Drafting

When using AI for drafting (D in DRAG):

```
Act in this role: [role]
Use this Input: [context/data]
This is your Mission: [what you need]
```
...
*"The top 1% use AI backwards. They don't prompt to get answers. They use it to train their brain."*
