# Milestone Detailed Design Instructions
...
**Parent Document**: [Milestones Overview](./milestones.md)
...
`docs/milestone-[number]-[slug].md` using `docs/milestone-detailed-template.md`
...
3. Copy to `milestone-detailed-template.md` → save as `milestone-1-web-core.md`
