...
- `~/.claude/skills/design/SKILL.md` - See "Stage 1: North Star" section
- `~/.claude/skills/design/references/1-north-star-guide.md` - Detailed process
- `~/.claude/skills/design/assets/templates/north-star.md` - Output template
...
**Mode Detection:**
- If `docs/[slug]-north-star.md` exists → Update mode (refine existing document based on user notes)
...
Create `docs/[slug]-north-star.md` using the template (e.g., `docs/mc-north-star.md`).
