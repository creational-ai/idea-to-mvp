...
Example usage:
- `/verify-doc docs/poc-plan.md`
- `/verify-doc docs/design.md docs/poc1-implementation.md`
- `/verify-doc docs/design.md docs/poc-plan.md --notes "Focus on Stage 4 requirements"`
