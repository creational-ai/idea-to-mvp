# /dev-milestone-details

Generate comprehensive milestone summary document from all task docs.

**Guide**: `~/.claude/skills/dev-cycle/references/milestone-details-guide.md`
**Template**: `~/.claude/skills/dev-cycle/assets/templates/milestone-details.md`
